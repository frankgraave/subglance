export type ReminderStatus = "scheduled" | "unconfirmed" | "acknowledged" | "resolved" | "paused" | "disabled" | "flapping" | "maintenance" | "initial_pending";
export type ReminderInfo = { count: number; remindedAt: string | null; nextAt: string | null; status: ReminderStatus };
const STATUSES: readonly string[] = ["scheduled", "unconfirmed", "acknowledged", "resolved", "paused", "disabled", "flapping", "maintenance", "initial_pending"];
